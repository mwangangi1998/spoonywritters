...
if (isset($_POST['submit']))
    ...
    if (!in_array($extension,['zip','pdf','png','docs','docx','doc','jpg'])) {
        echo "your file extension must be .zip ,.pdf or .png ,.doc";
        # code...
        }
        elseif(
            $_FILES['attach']['size'] >100000000)
            {
            ...
            if (move_uploaded_file($file ,$location)) {
                # code...
                $sql ="INSERT INTO ordertable(email,level,fmart,subject,npage,ordertime,txtarea,totalPrice,attach,size)
                VALUES
